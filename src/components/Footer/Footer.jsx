...
const Footer = () => {
  return (
    <div className=" bg-[#022D38] w-full min-h-[360px] px-14 py-8">
      ...
      <div className="bg-[#fff] h-[1px] w-[1154px]  mx-auto my-6"></div>
      <div className="flex gap-3 items-center justify-center">
        <span className=" text-sm  text-white">Copyright 2020,</span>
        <span className="text-sm   text-[#DC9935] ">
